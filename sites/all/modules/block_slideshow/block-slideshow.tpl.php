<div class="row-3">
    <div class="slider-wrapper">
        <div class="slider">
            <ul class="items">
                <li><img src="/sites/all/themes/training/images/slider-img1.jpg" alt="">
                    <strong class="banner">
                ...
                <li><img src="/sites/all/themes/training/images/slider-img2.jpg" alt="">
                    <strong class="banner">
                ...
                <li><img src="/sites/all/themes/training/images/slider-img3.jpg" alt="">
                    <strong class="banner">
